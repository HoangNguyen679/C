...
void 	AddEdge(Graph G, int v1, int v2, int weight, int indirected); //indirected==true: indirected edge.
...
//---------------------------------------------------------
void AddEdge(Graph G, int v1, int v2, int weight, int indirected)
{
